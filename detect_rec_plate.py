...
def det_rec_plate_pose(img,img_ori,detect_model,plate_rec_model):
    result_list=[]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--detect_model', nargs='+', type=str, default=r'weights/plate_pose.pt', help='model.pt path(s)') 
    ...
    for pic_ in file_list:
        ...
        # cv2.imwrite(os.path.join(save_path,f"roi_img_{count}.jpg"),roi_img)
        time_e=time.time()
